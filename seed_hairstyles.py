...
# Order is intentionally interleaved across categories (CLASSIC, MODERN,
# SHORT, LONG, PROTECTIVE, TEXTURED, BOLD, UPDO) so the catalog grid feels
# visually varied as the user scrolls — no two adjacent entries share a
# category, and entries added in issue #65 are spread throughout rather than
# clumped at the tail.
HAIRSTYLES_DATA = [
    {
        "name": "Classic Fade",
