# IRB compliance — logging (archived)

> Archived from the original `README.md`. TrueHair started as an IRB-supervised
> research study and has since transitioned to a consumer product. The notes
> below capture the IP-stripping logging posture set up during the study phase,
> in case the team ever needs to re-verify it for a follow-up review.
